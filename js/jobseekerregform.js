function validation()
           ...
           var visas=document.getElementById('visa').value;
          ...
          if(fuser == ""){
           ...
           if(exp == ""){
                 document.getElementById('experience').innerHTML="please fill the experience field";
                 return false;
           }
           if(isNaN(exp)){
                 document.getElementById('experience').innerHTML="Only digits are allowed";
                 return false;
           }
           if(visas == ""){
                 document.getElementById('visastatus').innerHTML="please enter visa status";
                 return false;
           }
           if(subj == ""){
